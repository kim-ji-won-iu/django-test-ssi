...
def upload_location(instance, filename, **kwargs):
    file_path = 'feedback/{author_id}/{title}-{filename}'.format(
...
@receiver(post_delete, sender=FeedbackPost)
def submission_delete(sender, instance, **kwargs):
    instance.image.delete(False)


def pre_save_feedback_post_receiever(sender, instance, *args, **kwargs):
    if not instance.slug:
        instance.slug = unique_slug_generator(instance)


pre_save.connect(pre_save_feedback_post_receiever, sender=FeedbackPost)
